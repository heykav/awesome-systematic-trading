...
- [DepthSight](https://github.com/depthsight-pro/depthsight) ![GitHub last commit (branch)](https://img.shields.io/github/last-commit/depthsight-pro/depthsight/main) ![GitHub Repo stars](https://img.shields.io/github/stars/depthsight-pro/depthsight?style=social) | `Python` `TypeScript` | - Self-hosted visual algo-trading platform featuring a drag-and-drop strategy builder, an AI co-pilot for automated strategy design, and integrated billing.
- [TradeSight](https://github.com/rmbell09-lang/tradesight) ![GitHub last commit (branch)](https://img.shields.io/github/last-commit/rmbell09-lang/tradesight/main) ![GitHub Repo stars](https://img.shields.io/github/stars/rmbell09-lang/tradesight?style=social) | `Python` | - AI-powered trading intelligence platform with automated strategy tournaments, multi-market scanning (stocks + prediction markets), 15+ technical indicators, paper trading, and web dashboard. Self-evolving strategies via overnight optimization cron.
...
- [StockKit](https://github.com/kentmswood-ui/stockkit) (site down: ~~stockkit.net~~) | `TypeScript` | - Free AI-powered stock research reports delivered daily. Wall Street-grade analysis for US, China & HK stocks using Claude Opus and multi-model AI engine. 20+ technical indicators, automated email delivery.
...
- [TraderHarness](https://github.com/HephaestLab/TraderHarness) ![GitHub last commit (branch)](https://img.shields.io/github/last-commit/HephaestLab/TraderHarness/main) ![GitHub Repo stars](https://img.shields.io/github/stars/HephaestLab/TraderHarness?style=social) | `Python` | - Contamination-resistant A-share backtesting environment for LLM trading agents: point-in-time masking, entity/date anonymization, progressive 5-minute execution, fingerprinted replay, and full-fidelity trajectory (SFT) export.
- [Algorier](https://algorier.com) | `AI` `No-code` `Vibe-Trading` | - Describe a strategy in English, get generated algorithm code plus a backtest and forward test, then run it live on your own broker account (15 brokers across forex, crypto, metals, indices, CFDs and equities) — or sell it on the AlgoNetwork marketplace, where buyers can run the strategy without seeing its logic.
...
- [flashalpha-fill-simulator](https://github.com/FlashAlpha-lab/flashalpha-fill-simulator) ![GitHub last commit (branch)](https://img.shields.io/github/last-commit/FlashAlpha-lab/flashalpha-fill-simulator/master) ![GitHub Repo stars](https://img.shields.io/github/stars/FlashAlpha-lab/flashalpha-fill-simulator?style=social) | Python, Options | - Realistic limit-order fill simulator for options credit/debit spreads. Models post-and-wait limits, stale-quote guards, deterministic same-bar tiebreaks, and a patient-then-cross exit. Engine-agnostic per-bar primitive that embeds in QuantConnect / Backtrader / custom loops; zero runtime dependencies.
...
- [DeepAlpha](https://github.com/stefanoviana/deepalpha) - `Python` | AI crypto trading bot for Bybit with 70.9% walk-forward validated accuracy. LightGBM + XGBoost ensemble with 72 ML features.
...
- [KLinePic](https://klinepic.com/) | `TypeScript` | - Converts broker and exchange trade records into annotated candlestick review charts with buy/sell markers, batch PNG/ZIP export, and an Agent API.
...
- [BDE Score™](https://github.com/hbhqq9/bde-score) ![GitHub last commit (branch)](https://img.shields.io/github/last-commit/hbhqq9/bde-score/master) ![GitHub Repo stars](https://img.shields.io/github/stars/hbhqq9/bde-score?style=social) | `Python`, `MCP` | - AI-powered multi-market stock analysis with transparent multi-factor scoring for 73 stocks across US, HK, and A-share markets. EU AI Act Art.50 compliant. MCP server + REST API.
...
- [Helium MCP](https://heliumtrades.com/mcp-page/) | `REST API`, `MCP` | - Real-time stock, ETF, and crypto data with AI bull/bear cases and price forecasts; ML options fair value (probability ITM, full Greeks); top-ranked options strategies (short vol, long vol); and news sentiment from 5,000+ sources. MCP server with REST endpoints. Free tier: 50 queries, no auth.
...
- [Parsec](https://github.com/parsecular/parsec-mcp) | `Rust`, `TypeScript`, `Python` | - Prediction market data, execution, and live streams across all major exchanges.
...
- [ToolsNova](https://toolsnova.net) - Free browser-based trading calculators for forex and gold traders. Includes XAU/USD pip calculator, margin calculator, position size calculator and 100+ other tools. No signup required.
